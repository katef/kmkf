...
# The nm(1) invocations below are a slightly hacky way to keep global
# symbols generated by some compilers. e.g. __x86.get_pc_thunk.* from
# gcc on FreeBSD i386, and __retguard_2540 from clang on OpenBSD amd64.
# I'm keeping everything that begins ^__ just in case new ones turn up.
# If you know a better way to do this, please do tell me.
...
.if ${SYSTEM} != Darwin
.if !empty(SYMS.${part})
	${NM} -g $@ | ${AWK} '/^__/ && $$2 != "U" {print $$1}' >> ${BUILD}/${SYMS.${part}}
